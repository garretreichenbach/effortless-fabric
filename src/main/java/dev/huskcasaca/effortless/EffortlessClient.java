...
//        return player.rayTrace(raytraceRange, 1f, RayTraceFluidMode.NEVER);
	...
	public void onInitializeClient() {
		...
		PayloadTypeRegistry.playS2C().register(ClientboundPlayerBuildModePacket.TYPE, ClientboundPlayerBuildModePacket.CODEC);
		PayloadTypeRegistry.playS2C().register(ClientboundPlayerBuildModifierPacket.TYPE, ClientboundPlayerBuildModifierPacket.CODEC);
		PayloadTypeRegistry.playS2C().register(ClientboundPlayerReachPacket.TYPE, ClientboundPlayerReachPacket.CODEC);

		// Register network packet handlers
		ClientPlayNetworking.registerGlobalReceiver(ClientboundPlayerBuildModePacket.TYPE, EffortlessClient::handlePacket);
		ClientPlayNetworking.registerGlobalReceiver(ClientboundPlayerBuildModifierPacket.TYPE, EffortlessClient::handlePacket);
		ClientPlayNetworking.registerGlobalReceiver(ClientboundPlayerReachPacket.TYPE, EffortlessClient::handlePacket);
	...
	public static void handlePacket(ClientboundPlayerBuildModePacket packet, ClientPlayNetworking.Context context) {
		BuildModeHelper.setModeSettings(context.player(), BuildModeHelper.sanitize(packet.modeSettings(), context.player()));
	}

	public static void handlePacket(ClientboundPlayerBuildModifierPacket packet, ClientPlayNetworking.Context context) {
	...
	public static void handlePacket(ClientboundPlayerReachPacket packet, ClientPlayNetworking.Context context) {
